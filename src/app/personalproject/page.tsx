...
export default function PersonalProject() {
  ...
  <div id="MasterMindProject">
    ...
    <p>
        ...
        Aesthetics toevoegen aan UX Design Globally. Vervolgens ben ik gaan kijken welke website ik wilde gaan omzetten naar de andere design style.
        ...
        <br></br><br></br>
        Om te testen wat gebruikers van de huidige AliExpress website vinden, ben ik een kleine interview met meerdere mensen gaan houden.
        Hier kwamen best wel wat punten uit die ik heb meegenomen in het maken van mijn wireframes en designs.
        <br></br><br></br>
        ...
        Daardoor ben ik redelijk wat tijd kwijtgeraakt aan mijn project. Ik heb ook een api toegevoegd, voor de derde leeruitkomst en heb geprobeerd
        de stijl die ik in figma heb gebruikt door te zetten in deze website met wat aanpassingen. 
    </p>
    </div>
    </div>
    </div>
