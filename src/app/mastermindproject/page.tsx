...
<br></br>
    <p>Het eerste project voor dit semester waar ik mee aan de gang ging is het Master Mind project.
      ...
      Vanuit hier ben ik aan de gang gegaan met een <a href="https://i461456.hera.fontysict.net/Racegame">Automatische Racebaan</a>. Dit was een onderdeel van het concept blokkenbouwrace.
      ...
      Voor dit project heb ik ook nog een <a href="https://i461456.hera.fontysict.net/pdfs/ProjectMasterMindsEindadvies.pdf">eindadviesdocument</a> (verwijzingen in het bestand: <a href="https://git.fhict.nl/I461456/master-minds-project">alle
      losse POCs</a> en <a href="https://i461456.hera.fontysict.net/pdfs/Onderzoekleerstijlendocentenenleerlingen.pdf">onderzoek naar leerstijlen</a>) geschreven om aan te geven welke functionaliteiten er al zijn, op welke manier het project
      nog uitgebreid kan worden en wat er nog gemaakt moet worden. Hierbij wordt telkens de context en een advies beschreven.
      </p>
      </div>
      </div>
      </div>
